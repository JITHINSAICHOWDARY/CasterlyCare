// One consistent icon family (24px grid, 1.75 stroke, round caps) for the
// shell — replaces the mixed Unicode glyphs, which rendered at uneven sizes.
const PATHS = {
  overview: (
    <>
  ...
  patients: (
    <>
      ...
      <path d="M16 4.5a3.5 3.5 0 0 1 0 7M18 21a7 7 0 0 0-3-5.7" />
    </>
  ),
  inbox: (
    <>
  ...
  droplet: <path d="M12 2c4 5 7 9 7 12a7 7 0 1 1-14 0c0-3 3-7 7-12z" />,
  thermometer: (
    <>
