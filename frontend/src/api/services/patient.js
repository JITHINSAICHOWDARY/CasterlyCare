...
export const patientService = {
  ...
  removeProfilePhoto() { return api.delete('/patient/profile/photo'); },
  ...
  getDoctorSpecializations() { return api.get('/patient/doctor-specializations'); },
  ...
  getDietRestrictions() { return api.get('/patient/diet-restrictions'); },
